...
const vaultItems: Array<{
...
}> = [
  {
    ...
    description: "Brand voice, sales copy, content, automations",
  },
  {
    icon: DatabaseZap,
    title: "Workflow Storage",
    description: "Repeatable systems that save hours every week",
  },
  {
    icon: ShieldCheck,
    title: "Business Intelligence",
    description: "Your best ideas organized and protected",
  },
];
        ...
        <div className="rounded-[2.4rem] bg-vault-slate p-5 text-white sm:p-6">
          <div className="mb-8 flex items-center justify-between gap-5">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black">Unlocked Workspace</h2>
            </div>
          ...
          <div className="mt-6 rounded-3xl bg-white p-5 text-vault-slate">
            <div className="mb-4 flex items-center justify-between">
              <p className="font-black">AI Asset Health</p>
