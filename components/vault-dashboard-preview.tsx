...
export function VaultDashboardPreview() {
  return (
    ...
    >
      ...
      <div className="relative rounded-[2rem] border border-white bg-white/70 p-3 shadow-2xl shadow-slate-300/40 backdrop-blur-xl sm:rounded-[3rem] sm:p-5">
        <div className="rounded-[1.65rem] bg-vault-slate p-4 text-white sm:rounded-[2.4rem] sm:p-6">
          <div className="mb-6 flex items-center justify-between gap-4 sm:mb-8 sm:gap-5">
            <div className="min-w-0">
              <p className="text-[0.65rem] font-bold uppercase tracking-[0.22em] text-cyan-300 sm:text-xs sm:tracking-[0.3em]">
                Community Status
              </p>
          ...
          <div className="grid gap-4">
            {vaultItems.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="rounded-3xl border border-white/10 bg-white/[0.07] p-4 sm:p-5"
              >
          ...
          <div className="mt-6 rounded-3xl bg-white p-4 text-vault-slate sm:p-5">
            <div className="mb-4 flex items-center justify-between gap-3">
              <p className="font-black leading-tight">Members Active</p>
